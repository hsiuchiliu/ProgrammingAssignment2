...
## containing four elements. The four elements are functions that 
## (1) set the value of the matrix,
## (2) get the value of the matrix, 
## (3) set the inverse of the matrix, and 
## (4) gets the inverse of the matrix. 
## The four functions are defined such that their returned values are available in an environment that is different to the environment where they are defined
